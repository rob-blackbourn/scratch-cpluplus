...
struct A
{
    ...
    A()
        : s("test"),
          k(-1)
    {
        std::cout << "A: default constructor - ok\n";
    }
    ...
    A(const A &o)
        : s(o.s),
          k(o.k)
    {
        std::cout << "A: copy constructor - move failed!\n";
    }
    ...
    {
        std::cout << "A: move constructor - ok\n";
    }
};
...
struct C : B
{
    // destructor prevents implicit move constructor C::(C&&)
    ~C()
    {
